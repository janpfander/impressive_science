...
\begin{figure}
\centering
\includegraphics{output/figures/overview-plot.pdf}
...
\begin{figure}
\centering
\includegraphics{output/figures/distribution-knowledge.pdf}
