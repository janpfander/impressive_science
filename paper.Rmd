...
table(exp2$competence)

# Define the neutral midpoint
neutral_midpoint <- 3

# Perform a one-sample t-test
t_test_competence <- t.test(
  exp2$competence,
  mu = neutral_midpoint
)

# View the results
print(t_test_competence)

# Perform a Wilcoxon signed-rank test
wilcox_test_competence <- wilcox.test(
  exp2$competence,
  mu = neutral_midpoint
)

# View the results
print(wilcox_test_competence)
